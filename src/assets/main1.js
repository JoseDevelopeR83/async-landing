...
const API ='https://youtube-v31.p.rapidapi.com/search?channelId=UCQt9awGIFZeldFsATZNeJag&part=snippet%2Cid&order=date&maxResults=9';
...
const options = {
	...
	headers: {
		...
		'X-RapidAPI-Key': '49c5f1db13mshb6a26ab8e6e96e5p13aca2jsn37f2275ab1c0'	
	}
};
